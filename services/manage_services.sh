...
services=("air_quality" "ambient" "noise_sensor" "aq_dashboard" "light_sensor" "carbon_dioxide_sensor" "voc_nox_sensor" "pressure_sensor" "o3_no2_sensor" "co_sensor" "radon_sensor")
