...
services=("dust_sensor" "ambient_sensor" "noise_sensor" "aq_dashboard" "light_sensor" "carbon_dioxide_sensor" "voc_nox_sensor" "pressure_temp_sensor" "o3_no2_sensor" "co_sensor" "radon_sensor")
